...
Installs WordPress and generates seed data from plugins.

[![Build Status](https://travis-ci.org/onnimonni/seed-command.svg?branch=master)](https://travis-ci.org/onnimonni/seed-command)
...
To install the latest version of this package run:
    ...
    wp package install git@github.com:onnimonni/seed-command.git
